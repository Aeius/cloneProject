...
public class Pagination {
	...
	private int firstRecordIndex; 		// sql의 조건절에 사용되는 시작 페이지 번호
	...
	public void setFirstPageNoOnPageList(int firstPageNoOnPageList) {this.firstPageNoOnPageList = firstPageNoOnPageList;}
	...
	public int getLastPageNoOnPageList() {
		...
		if (realEnd < lastPageNoOnPageList)lastPageNoOnPageList = realEnd;
		return lastPageNoOnPageList;
	}
	public void setLastPageNoOnPageList(int lastPageNoOnPageList) {this.lastPageNoOnPageList = lastPageNoOnPageList;}

	public int getFirstRecordIndex() {
		firstRecordIndex = (getCurrentPageNo() - 1) * getRecordCountPerPage();
		return firstRecordIndex;
	}
	public void setFirstRecordIndex(int firstRecordIndex) {this.firstRecordIndex = firstRecordIndex;}

	public boolean getXprev() {
		xprev = getFirstPageNoOnPageList() > 1;
		return xprev;
	}
	public void setXprev(boolean xprev) {this.xprev = xprev;}
	...
	public void setXnext(boolean xnext) {this.xnext = xnext;}
