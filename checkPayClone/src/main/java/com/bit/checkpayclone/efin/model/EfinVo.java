...
public class EfinVo {
	...
	/**
	 * 데이터 가공 조회를 위한 추가 변수
	 * @param pay_method_name    결제 방법 이름 출력 위해
	 * @param trans_org_name    결제수단 기관 이름 출력 위해
	 * @param trans_pay_name    결제수단 이름 출력 위해
	 */
	
	String pay_method_name, trans_org_name, trans_pay_name;
